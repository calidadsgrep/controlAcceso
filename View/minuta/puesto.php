...
<div class="row clearfix">
                <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Control/Registro Diario del Puesto <small><?php echo strtoupper($datos[0]['Nombre'] . ' ' . $datos[0]['Apellido']) ?></small>
                            </h2>
                        </div>
                        <div class="body">
                                ...
                                <div class="col-sm-12 text-center">
                                    ...
                                    <div class="form-line">
                                        <label for="">Observación</label>
                                            <textarea type="text" name="observacion" class="form-control" placeholder="Digite aqui si hay alguna evento que desee registrar" ></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 text-center">
                    ...
                    <div class="card">
                        <div class="header">
                           ...
                           <div class="header-dropdown m-r--5">
                            ...
                            <button type=""  onclick="Index(<?php echo $_SESSION['puesto'] ?>);" data-toggle="modal" data-target="#largeModal" class="btn btn-primary btn-lg m-l-15 waves-effect">
                                                     Registrar
                            </button>
                            </div>                    
                            </div>
                                         ...
                                         <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                            ...
                                            <tfoot>
                                             <tr>
                                                ...
                                                <tbody>
                                             <?php foreach ($this->model->ObtenerInv($_SESSION['puesto']) as $inventario): ?>
                                             <tr>
                                               ...
                                               <!-- <a onclick="javascript:return confirm('Estas seguro que deseas eliminar el registro?')" href="?c=control_ingreso&a=Eliminar&id=<?php echo $inventario->id ?>"> <i class="material-icons">clear</i></a>--></td>
                                           </tr>
                                           </tbody>
                                             <?php endforeach;?>
                                         </table>
